    ...
    <div className="fixed bottom-8 right-8 z-50">
      <div className="relative">
        ...
        <div className={`absolute bottom-16 right-0 space-y-3 transition-all duration-300 ${isOpen ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'}`}>
          {/* Email */}
          <div className="w-8 h-8 bg-coffee-green  flex items-center justify-center transform rotate-12 hover:scale-110 transition-transform cursor-pointer" title="Email us">
            <Mail className="w-4 h-4 text-coffee-text-primary transform -rotate-12" />
          </div>
          
          {/* Telegram */}
          <div className="w-8 h-8 bg-blue-500  flex items-center justify-center transform -rotate-30 hover:scale-110 transition-transform cursor-pointer" title="Telegram">
          ...
          {/* Viber */}
          <div className="w-8 h-8 bg-purple-500  flex items-center justify-center transform -rotate-70 hover:scale-110 transition-transform cursor-pointer" title="Viber">
          ...
          {/* Phone */}
          <div className="w-8 h-8 bg-coffee-green  flex items-center justify-center transform -rotate-110 hover:scale-110 transition-transform cursor-pointer" title="Call us">
