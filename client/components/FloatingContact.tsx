    ...
    <div className="fixed bottom-8 right-8 z-50">
      <div className="relative">
        ...
        <div className={`absolute bottom-16 right-0 space-y-3 transition-all duration-300 ${isOpen ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'}`}>
          {/* Email */}
          <div className="w-8 h-8 bg-[#1f0a03] rounded-full flex items-center justify-center transform rotate-12 hover:scale-110 transition-transform cursor-pointer" title="Email us">
            <Mail className="w-4 h-4 text-white transform -rotate-12" />
          </div>
          ...
          <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center transform -rotate-30 hover:scale-110 transition-transform cursor-pointer" title="Telegram">
            <svg className="w-4 h-4 text-white transform rotate-30" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="w-8 h-8 bg-purple-500 rounded-full flex items-center justify-center transform -rotate-70 hover:scale-110 transition-transform cursor-pointer" title="Viber">
            <svg className="w-4 h-4 text-white transform rotate-70" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Phone */}
          <div className="w-8 h-8 bg-[#1f0a03] rounded-full flex items-center justify-center transform -rotate-110 hover:scale-110 transition-transform cursor-pointer" title="Call us">
            <Phone className="w-4 h-4 text-white transform rotate-110" />
          </div>
        </div>
        ...
        >
          <MessageCircle className="w-8 h-8 text-[#1f0a03]" />
        </div>
      </div>
    </div>
  );
